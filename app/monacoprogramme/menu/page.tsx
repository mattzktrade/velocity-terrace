...
const navItems = [
  ...
  { label: 'Menu', href: '/monacoprogramme/menu', icon: UtensilsCrossed, active: true },
  ...
  return (
    <article className="relative min-h-[420px] border border-[#E7E1D6] bg-[#F7F3EA] p-8 sm:p-10">
      <div className="flex items-start gap-5">
        <Icon className="mt-0.5 h-12 w-12 shrink-0 text-[#E8390E]/55" />
        <div>
          ...
          {section.subtitle ? (
            <p className="mt-2 font-[family-name:var(--font-inter)] text-sm text-[#E8390E]/80">{section.subtitle}</p>
          ) : null}
      ...
      {items.map((item) => {
        ...
        return (
          <div key={item.title} className="border-b border-[#E7E1D6] p-7 text-center last:border-b-0 sm:border-b-0 sm:border-r sm:last:border-r-0">
            <Icon className="mx-auto h-8 w-8 text-[#E8390E]/55" strokeWidth={1.5} />
